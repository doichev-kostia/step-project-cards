...
import {CreateElement, Input, Select, TextArea, Button} from "./CreateElements.js";
...
export class Visit{
    ...
    renderTemplate(receivedVisitDetails){
        ...
        elements.cardContainer = new CreateElement("div", classListObj.cardContainer).render();

        elements.fullNameLabel = new CreateElement("label",classListObj.inputsDisabled , "Пациент: ").render();
        elements.fullName = new Input(elements.fullNameLabel, `${receivedVisitDetails.fullName}`, classListObj.inputsDisabled, "text");

        elements.doctorLabel = new CreateElement("label", classListObj.labels, "Врач: ").render();
        elements.doctor = new Input(elements.doctorLabel, `${receivedVisitDetails.doctor}`,classListObj.inputsDisabled, "text");

        elements.priorityLabel = new CreateElement("label", classListObj.labels, "Срочность: ").render();
        elements.priority = new Input(elements.priorityLabel, `${receivedVisitDetails.priority}`, classListObj.inputsDisabled, "text");

        elements.reasonLabel = new CreateElement("label", classListObj.labels, "Цель визита: ").render();
        ...
        elements.actionsContainer = new CreateElement("div", classListObj.actionsContainer).render();
...
export class VisitDentist extends Visit{
    ...
    render(receivedVisitDetails) {
        ...
        elements.dateLabel = new CreateElement("label", classListObj.labels, "Дата последнего посещения").render();
